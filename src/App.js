...
const [total, setTotal] =useState(false)
 ...
 // condition that if use . cannot use . again
const inputNum = (e) => {
...
//to concordinate the numbers typed , i.e 123 .
 curState 
...
const minusPlus = () => {
  ...
  if(curState.charAt(0) ==="-"){ setCurState(curState.substring(1));}
  else{ setCurState("-"+ curState);}
};

const percent = () => {

  
  if(preState){setCurState(String(parseFloat(curState/100) * preState));}
  else{setCurState(String(curState)/100);}
};
